        ...
        public static string MaViTri
        {
            get
            {
                try
                {
                    ...
                    object obj = HttpContext.Current.User.Identity.Name.Split(';')[8];
                    return (obj == null) ? String.Empty : (string)obj;
                }
                catch
                {
